...
Button(tab2, text='CANCEL', command=RST,font=("Arial Bold", 15),foreground =("red"),background  =("green")).grid(row=6, column=1, sticky=W, pady=4)
...
Button(tab2, text='TRAIN', command=RUNMODEL,font=("Arial Bold", 15),foreground =("red"),background  =("yellow")).grid(row=1, column=0, sticky=W, pady=4)
